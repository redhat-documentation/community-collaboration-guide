[id="ccg-project-structure_{context}"]
== Project structure
...
include::modules/con-repository_and_directory_structure.adoc[leveloffset=+2]

include::modules/con-flat-file-structure.adoc[leveloffset=+2]

include::modules/con-single-book-structure.adoc[leveloffset=+2]

include::modules/con-multiple-book-structure.adoc[leveloffset=+2]

include::modules/con-considerations-sharing-repo.adoc[leveloffset=+2]

include::modules/con-content_structure.adoc[leveloffset=+2]

include::modules/con-file_naming.adoc[leveloffset=+2]
